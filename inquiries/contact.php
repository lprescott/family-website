...
<body>
  ...
  <div id="main">
    ...
    <div class="flex-col flex-container">
      <div id="contact-racaptcha-send" class="flex-row container">
      ...
      <div class="item " style="flex-basis: 100%;">
        <h2>Body</h2>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi bibendum aliquam libero, quis euismod lectus
          tristique vitae. Integer vitae laoreet dui. Quisque ac sodales quam. Maecenas bibendum eget nibh ut accumsan.
          Aenean hendrerit eleifend nisi, sed sodales dolor congue non. Cras efficitur finibus molestie. Nullam sed
          euismod diam. Sed iaculis ipsum et lectus accumsan, vel fringilla tortor dictum. Ut egestas consequat
          euismod.
        </p>
      </div>
    </div>
