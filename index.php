      ...
      <nav class="nav">
        <ul class="rounded-corners">
          ...
          <li class="home-button">
            <a style="padding: 9px 11px 9px 11px; " title="Home" href="index.php">
          ...
          <li class="contact-button">
            <a style="padding: 13px 15px 14px 15px;" title="Contact Us" href="inquiries/contact.php">
          ...
          <li class="dropdown mobile-button">
            <a style="padding: 12.5px 15px 12.5px 15px;" title="Menu">
            ...
            <ul>
              <li id="people" class="top-dropdown-item" style="width: 270px;">
                <a href="#" onclick="showOrHide('person', 'projects');">People
                  <i style="font-size: 12px;" class="fas fa-angle-down"></i>
                </a>
              </li>
              <li class="sub-item person" style="width: 270px;">
                <a href="/people/drewprescottsr.html">Drew Prescott, Sr.</a>
              </li>
              <li class="sub-item person" style="width: 270px;">
                <a href="/people/karenprescott.html">Karen Prescott</a>
              ...
              <li id="property" style="width: 270px;">
                <a href="#" onclick="showOrHide('property', 'projects');">Property
                  <i style="font-size: 12px;" class="fas fa-angle-down"></i>
                </a>
              </li>
              <li class="sub-item property" style="width: 270px;">
                <a href="/property/inside.html">Inside</a>
              </li>
              <li class="sub-item property" style="width: 270px;">
                <a href="/property/outside.html">Outside</a>
              ...
              <li class="sub-item project" style="width: 270px;">
                <a href="../projects/OAP.html">Ocular Audiobook Player</a>
              </li>
              <li class="sub-item bottom-dropdown-item project" style="width: 270px;">
                <a href="../projects/pre-Sportus.html">pre-Sport us!</a>
              </li>
